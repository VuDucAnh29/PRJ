...
public class MainController extends HttpServlet {
    ...
    private static final String VIEW_CONTROLLER="cart.jsp";
    private static final String VIEW="View";
    private static final String REMOVE_FROM_CART_CONTROLLER="RemoveController";
    ...
    private static final String ADD_INFO_CONTROLLER="AddInfoController";
    private static final String ADD_INFO="Add Information";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if(ADD_INFO.equals(action)) {
